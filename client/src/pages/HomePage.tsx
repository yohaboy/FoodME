...
export default function HomePage() {
    ...
    const RadioOption = ({ value, label, active, onClick }: { value: string, label: string, active: boolean, onClick: () => void }) => (
        <button
            type="button"
            onClick={onClick}
            className={`flex items-center gap-3 p-5 rounded-2xl border-2 transition-all w-full text-left ${active
        ...
        >
            ...
            <span className={`text-xs font-bold uppercase tracking-widest ${active ? "text-text-base" : "text-text-muted"}`}>
                {label}
            </span>
        </button>
    );
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-bold uppercase tracking-[0.3em]">Neural Gastronomy v2.0</span>
                        </motion.div>
                        <motion.h1
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="text-6xl sm:text-7xl lg:text-9xl font-bold tracking-tighter leading-[0.85] mb-12"
                        >
                    ...
                    >
                        <div className="text-right">
                            <span className="block text-[10px] font-bold uppercase tracking-widest text-text-muted mb-1">Current Phase</span>
            ...
            <div className="max-w-5xl">
                {error && (
                    <motion.div
                        ...
                        className="mb-12 p-8 border-2 border-text-base bg-bg-surface text-[10px] font-bold uppercase tracking-[0.3em] text-center rounded-3xl flex flex-col items-center gap-6"
                    >
                    ...
                    <AnimatePresence mode="wait">
                            ...
                            >
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                                    <div className="lg:col-span-4">
                                        <h2 className="text-4xl font-bold mb-4 tracking-tight">Current Mood</h2>
                                        <p className="text-text-muted font-light leading-relaxed text-lg">Your current mood acts as the primary filter for our flavor synthesis engine.</p>
                                    </div>
                                    <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {MOODS.map((mood) => (
                                            <div
                                                ...
                                                className={`option-card group ${formData.mood === mood.value ? 'active' : ''}`}
                                            >
                                                <div className="flex justify-between items-start">
                                                    <div className="space-y-1">
                                                        <h3 className="font-bold text-xl uppercase tracking-tight">{mood.label}</h3>
                                                        <p className="text-sm text-text-muted font-medium leading-relaxed">{mood.desc}</p>
                                                    </div>
                        ...
                        {step === 2 && (
                            ...
                            >
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                                    <div className="lg:col-span-4">
                                        <h2 className="text-4xl font-bold mb-4 tracking-tight">Dietary Framework</h2>
                                        <p className="text-text-muted font-light leading-relaxed text-lg">Establish the nutritional boundaries for your recommendation set.</p>
                                    </div>
                                    <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {DIETS.map((diet) => (
                                            <div
                                                ...
                                                className={`option-card group ${formData.diet_type === diet.value ? 'active' : ''}`}
                                            >
                                                <div className="flex justify-between items-start">
                                                    <div className="space-y-1">
                                                        <h3 className="font-bold text-xl uppercase tracking-tight">{diet.label}</h3>
                                                        <p className="text-sm text-text-muted font-medium leading-relaxed">{diet.desc}</p>
                                                    </div>
                                ...
                                <div className="flex justify-between pt-12 border-t border-border-base">
                            ...
                            >
                                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                                    <div className="lg:col-span-4">
                                        ...
                                        <p className="text-text-muted font-light leading-relaxed text-lg">Fine-tune the remaining variables for maximum precision.</p>
                                    </div>
                                    <div className="lg:col-span-8 space-y-16">
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                                            <div className="space-y-10">
                                                <div>
                                                    <label className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-text-muted mb-6">
                                                ...
                                                <div>
                                                    ...
                                                    >
                                                        <SelectTrigger className="input-field h-16 text-sm font-bold uppercase tracking-widest">
                                                            <SelectValue />
                                                        </SelectTrigger>
                                            ...
                                            <div className="space-y-10">
                                                ...
                                                <div>
                                                    <div className="flex justify-between items-center mb-8">
                                                        <label className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.2em] text-text-muted">
                                                            <DollarSign size={12} /> Economic Range
                                                        </label>
                                                        <span className="text-sm font-bold tabular-nums">${formData.cost_range_min} — ${formData.cost_range_max}</span>
                                                    </div>
                                                    <Slider
